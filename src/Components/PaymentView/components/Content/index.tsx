...
const {requestCode} = useParams();
  ...
  const paymentDetail = PaymentRequestDetail.filter(
    (pr) => pr.requestCode === requestCode
  );
        ...
        <div
          ...
          <div className="parent-row-info">
            <Row className="child-row-info">
              <Col span={24}>
                <b>Request Code: {pd.requestCode} </b>
              </Col>
            </Row>
            <Row className="child-row-info">
              <Col span={24}>
                <b>Created by: {pd.userName}</b>
              </Col>
            </Row>
            <Row className="child-row-info">
              <Col span={24}>
                <b>Created at:{pd.createAt}</b>
              </Col>
            </Row>
            <Row className="child-row-info">
              <Col span={24}>
                <b>Status:{pd.status}</b>
              </Col>
            </Row>
          </div>
